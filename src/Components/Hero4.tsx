...
<div className=''>
    <h4 className=' text-lg md:text-xl font-semibold pt-2 md:pt-4'>Using Good Quality Materials</h4>
    <p className=' pt-2 md:pt-5 text-sm md:text-lg'>Lorem ipsum dolor sit amt, consectetur adipiscing elit.</p>
</div>
<div className=''>
    <h4 className=' text-lg md:text-xl font-semibold pt-2 md:pt-4'>Using Good Quality Materials</h4>
    <p className=' pt-2 md:pt-5 text-sm md:text-lg'>Lorem ipsum dolor sit amt, consectetur adipiscing elit.</p>
...
<div className='w-full xl:w-1/2 flex flex-col justify-center lg:flex-row py-3 lg:py-0 items-stretch  space-x-0 lg:space-x-8'>
     ...
     <Link href="/product" className='px-3 py-3 rounded rounded-lg bg-green-500 text-white'>See All Product</Link>
     </div>
