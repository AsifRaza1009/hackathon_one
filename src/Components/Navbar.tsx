      ...
      {isOpen && (
        <div className='absolute z-50 bg-white h-screen w-full flex flex-col space-y-2 top-20 text-center pt-10 '>
          <Link onClick={() => {
            ...
            href='/' className='hover:text-red-500 hover:scale-105' >
            Home
          </Link>
          <Link onClick={() => {
              setIsOpen(false);
            }}
            href='/female' className='hover:text-red-500 hover:scale-105'>
            Female
          </Link>
          <Link onClick={() => {
              setIsOpen(false);
            }}
            href='/male' className='hover:text-red-500 hover:scale-105'>
            Male
          </Link>
          <Link onClick={() => {
              setIsOpen(false);
            }}
            href='/kids' className='hover:text-red-500 hover:scale-105'>
            Kids
          </Link>
          <Link onClick={() => {
              setIsOpen(false);
            }}
            href='/product' className='hover:text-red-500 hover:scale-105'>
            All Products
          </Link>
        </div>
      )}
