      ...
      <div className="pb-10">
        ...
        <div className=' flex flex-col md:flex-row md:space-x-3 justify-around'>
          ...
          <div className='bg-gray-50 '>
            ...
            <button onClick={checkoutHandle} className='tracking-widest bg-[#474747] px-4 md:px-12 w-fit mx-auto py-2 border border-transparent rounded-lg font-bold items-center text-white'>
              Process to checkout
            </button>
          </div>
        </div>
